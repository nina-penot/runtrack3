            ...
            <div class="bg-light p-3">
                ...
                <nav class="d-flex justify-content-end" aria-label="Page navigation example">
                    <ul class="pagination">
                        ...
                        <li class="page-item"><a class="page-link" onclick="page_change(1)">1</a></li>
                        <li class="page-item"><a class="page-link" onclick="page_change(2)">2</a></li>
                        <li class="page-item"><a class="page-link" onclick="page_change(3)">3</a></li>
                        <li class="page-item">

...
<body>
    ...
    <footer class="bg-sky-500 p-3">
        <ul class="gap-4">
            <li class="rounded-2xl bg-sky-600 p-3 hover:bg-blue-800 mb-3 w-3/4"><a class="bg-amber-50" href="">Accueil</a></li>
            <li class="rounded-2xl bg-sky-600 p-3 hover:bg-blue-800 mb-3"><a href="">Inscription</a></li>
            <li class="rounded-2xl bg-sky-600 p-3 hover:bg-blue-800 mb-3"><a href="">Connexion</a></li>
            <li class="rounded-2xl bg-sky-600 p-3 hover:bg-blue-800 "><a href="">Rechercher</a></li>
        </ul>
    </footer>
</body>
